...
## Actual choices and steps

- The golden set is a list of 10 questions manually tested - the result value matches the expected value
- Wrote 22 snippets providing information about columns and a few examples of queries
- Sent all snippets for each question
